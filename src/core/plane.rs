...
impl Plane {
    ...
    pub fn new(pop: Vec3<f64>, normal: Vec3<f64>) -> Self {
        Self {
            pop,
    ...
    pub fn point_on_plane(&self) -> &Vec3<f64> {
        &self.pop
    }
    ...
    pub fn distance_to_point(&self, p: &Vec3<f64>) -> f64 {
    ...
    pub fn distance_to_point_abs(&self, p: &Vec3<f64>) -> f64 {
