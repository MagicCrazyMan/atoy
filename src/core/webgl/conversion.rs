...
impl ToGlEnum for ArrayBufferDataType {
    ...
    fn gl_enum(&self) -> u32 {
        match self {
            ...
            ArrayBufferDataType::UNSIGNED_BYTE => WebGl2RenderingContext::UNSIGNED_BYTE,
            ArrayBufferDataType::UNSIGNED_SHORT => WebGl2RenderingContext::UNSIGNED_SHORT,
            ArrayBufferDataType::UNSIGNED_INT => WebGl2RenderingContext::UNSIGNED_INT,
            ArrayBufferDataType::HALF_FLOAT => WebGl2RenderingContext::HALF_FLOAT,
            ArrayBufferDataType::INT_2_10_10_10_REV => WebGl2RenderingContext::INT_2_10_10_10_REV,
            ArrayBufferDataType::UNSIGNED_INT_2_10_10_10_REV => {
...
impl ToGlEnum for IndicesDataType {
    ...
    fn gl_enum(&self) -> u32 {
        match self {
            IndicesDataType::UNSIGNED_BYTE => WebGl2RenderingContext::UNSIGNED_BYTE,
            IndicesDataType::UNSIGNED_SHORT => WebGl2RenderingContext::UNSIGNED_SHORT,
            IndicesDataType::UNSIGNED_INT => WebGl2RenderingContext::UNSIGNED_INT,
        }
    }
}
