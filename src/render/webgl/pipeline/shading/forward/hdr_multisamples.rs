...
use crate::render::webgl::{
    ...
    framebuffer::{
        ...
        FramebufferBuilder, FramebufferDrawBuffer, FramebufferTarget,
    },
    pipeline::{
...
impl StandardMultisamplesHdrShading {
    ...
    unsafe fn draw_hdr_multisamples(
        ...
        hdr_multisamples_framebuffer.clear_buffer_bits()?;
        draw_entities(
            state,
            &DrawState::Draw {
                universal_ubo,
    ...
    unsafe fn draw_hdr_multisamples_bloom(
        ...
        hdr_multisamples_bloom_framebuffer.clear_buffer_bits()?;
        draw_entities(
            state,
            &DrawState::Draw {
                universal_ubo,
